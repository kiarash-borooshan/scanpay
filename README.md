...
- لازم به ذکر است منافع مالی بدست آمده از این وب‌سایت بین مشارکت‌کنندگان براساس میزان و نوع مشارکت تقسیم خواهد شد.
...
-  انتخاب نوع پرداخت اعم از کارت‌خوان، کارت به کارت، رمزارز، تهاتر
-  امکان ارسال فاکتور توسط پیامک
-  امکان مرجوعی، تعویض و ...
-  سرویس‌های مکان‌مبنا اعم از:
-  ۱-امکان ثبت مکان فروشگاه.
-  ۲-ارائه سرویسی شبیه «کوجاس، اطراف من، دانرو» برای پیدا کردن نزدیک‌ترین فروشگاه و نمایش کالاهای موجود در مغازه در صورت تایید مدیریت
...
- توضیحات تکمیلی به زبان ساده در یک فایل ویدئوئی در لینک زیر ارائه شده است.
